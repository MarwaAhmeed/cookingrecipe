          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul className="navbar-nav flex-row">
              ...
              {auth?<div className="d-flex" >
                        <p className=" mt-2 text-white">{auth.userName}</p>
                         <Link className="text-decoration-none  mt-2 px-5  w-100 text-center pointer text-white" to={""} onClick={logout}>Logout</Link>
                    </div>
